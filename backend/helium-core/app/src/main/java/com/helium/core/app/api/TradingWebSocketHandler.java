...
public class TradingWebSocketHandler extends TextWebSocketHandler {
    ...
    public TradingWebSocketHandler(JwtTokenService jwtTokenService, ObjectMapper objectMapper) {
    ...
    private String event(String type, Object payload) {
        try {
            ...
            throw new IllegalStateException("trading websocket payload serialization failed", exception);
        }
    }
